...
horaAgendada varchar(10),
dataAgendada date,
localAgendado varchar(50),
statusVistoria varchar(20),
dataRealizacaoVistoria date,
vistoriadorChef varchar(20),
vistoriadorAux varchar(20),
